...
export const OrdersPage: FC = () => {
    ...
    return (
      ...
      <main className={orderStyles.profileMain}>
        <section className={orderStyles.profileMenu}>
        ...
        <section className={orderStyles.profileOrdersSection}>
          <div className={`${orderStyles.profileOrdersContainer} pr-2`}>
